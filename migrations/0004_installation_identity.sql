...
-- Deploy-button installations created before this migration all published this
-- legacy identity. Preserve it when upgrading; new installations get a unique
-- identity from the Worker after migrations and before verification.
