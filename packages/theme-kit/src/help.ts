const COMMAND_HELP: Record<string, string> = {
  init: `Usage: microfeed-theme init <directory>
...
directory.`,
  preview: `Usage: microfeed-theme preview <directory> [options]
...
Options:
  ...
  test: `Usage: microfeed-theme test <directory> [--json]
...
the generated HTML, and validate the rendered RSS XSL stylesheet.`,
  validate: `Usage: microfeed-theme validate <directory> [--json]
...
assets, paths, file types, sizes, Mustache, and RSS XSL.`,
  "fixture pull": `Usage: microfeed-theme fixture pull <json-feed-url> --output <file>
...
Usage:
  microfeed-theme <command> [options]
...
Documentation: https://docs.microfeed.org/dashboard/themes/`;
