...
export const CLI_COMMANDS: readonly CliCommandMetadata[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Init copies the selected instance's effective theme into a new local authoring repository: active D1 version, then built-in default. Upgraded sites import their selected old custom theme into D1 first. Init assigns a separate local package identity and initializes Git unless --no-git is passed.",
      "Install accepts a local directory or public GitHub repository, directory, or microfeed-theme.json URL. GitHub refs resolve to an exact commit before any package file is fetched.",
    ...
    examples: [
      ...
      "yarn manage theme init ./my-theme --instance personal --package-id example.my-theme --author \"Your name\"",
    ...
    options: [
      ...
      option("--output <directory>", "Choose the empty init/export directory."),
