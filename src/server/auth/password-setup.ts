...
function goneResponse(): Response {
  return textResponse(
    "This password link has expired or was replaced. Run `yarn admin auth setup` for first-time setup, or `yarn admin auth reset-password` for an existing administrator.",
    410,
  );
}
